setup-secret:
	...
	printf "crypto_key=\"" > authentication2/certificate/secret.py
	...
	cat secret | tr -d "\n" >> authentication2/certificate/secret.py
	cat secret | tr -d "\n" >> backend/secret
	cat secret | tr -d "\n" >> production_secret
	printf "\"" >> authentication/certificate/secret.py
	printf "\"" >> authentication2/certificate/secret.py
	rm secret
